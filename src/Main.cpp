...
void CMain::InitializeControlsL()
	...
	AddListBoxResourceArrayItemL( R_MAIN_LISTBOX_ITEM8 );
 ...
 *	Get the listbox.
 */
CAknDoubleStyleListBox* CMain::ListBox()
	{
	return iListBox;
	}
...
void CMain::HandleListBoxEnterKeyPressedL( 
		...
		TListBoxEvent anEventType )
	{
	((CMainView*)iCommandObserver)->HandleLBSelect(iListBox->CurrentItemIndex());		
	}
